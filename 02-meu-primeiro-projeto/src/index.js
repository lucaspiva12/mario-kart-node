...
async function playRaceEngine(character1, character2) {
    for(let round = 1; round <= 5; round++){
        ...
        if(block === "CURVA") {
            totalTestSkill1 = diceResult1 + character1.MANOBRABILADADE;
            totalTestSkill1 = diceResult2 + character2.MANOBRABILADADE;

            
            await logRollResult(character1.NOME,
                "manobrabilidade", 
                diceResult1, 
                character1.MANOBRABILADADE);

            await logRollResult(character2.NOME, 
                "manobrabilidade", 
                diceResult2, 
                character2.MANOBRABILADADE);
        }
        if(block === "CONFRONTO") {
